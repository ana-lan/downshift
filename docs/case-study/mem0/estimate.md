...
Call sites: 4 added, 0 changed, 1 removed, 13 unchanged.

| Change | Call site | Model | Tokens/call (in + out) | Calls/day | Monthly | Delta |
|---|---|---|---|---|---|---|
| added | `mem0/memory/main.py::Memory._add_to_vector_store` | gpt-5-mini | 5093 + 2000 | 10,000 | $1,581.98 | +$1,581.98 |
| added | `mem0/memory/main.py::Memory._create_procedural_memory` | gpt-5-mini | 705 + 2000 | 100 | $12.53 | +$12.53 |
| added | `mem0/memory/utils.py::get_image_description` | gpt-5-mini | 31 + 2000 | 500 | $60.12 | +$60.12 |
| added | `mem0/reranker/llm_reranker.py::LLMReranker.rerank` | gpt-5-mini | 100 + 100 | 100,000 | $675.00 | +$675.00 |
| removed | `mem0/llms/openai.py::OpenAILLM.generate_response` | gpt-5-mini† | 0§ + 256‡ | 20,000 | $307.20 -> $0.00 | -$307.20 |
